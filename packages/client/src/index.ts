...
mp.events.add('playerReady',()=>{installCefBridge();registerAuthModule();registerCharacterModule();registerSessionModule();registerEconomyModule();registerInventoryModule();registerJobModule();registerFamilyModule();registerVehicleModule();registerPropertyModule();registerBusinessModule();registerMarketplaceModule();registerPhoneModule();registerQuestModule();registerTabletModule();prepareEntryScene();mp.events.callRemote('eclipse:client:ready');});